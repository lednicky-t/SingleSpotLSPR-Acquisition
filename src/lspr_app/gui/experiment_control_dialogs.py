...
class ExperimentControlDialogs:
    ...
    def _make_close_button(self, parent: QWidget) -> QToolButton:
        ...
        button.setIcon(self._tint_icon(tabler_icon("x"), QColor(self._theme_palette["muted"])))
    ...
    def edit_color_palette_entries(self, entries: list[tuple[str, str]], anchor: QWidget | None = None) -> list[tuple[str, str]] | None:
        ...
        move_up_button.setIcon(self._tint_icon(tabler_icon("chevron_up"), QColor(self._theme_palette["muted"])))
        ...
        move_down_button.setIcon(self._tint_icon(tabler_icon("chevron_down"), QColor(self._theme_palette["muted"])))
